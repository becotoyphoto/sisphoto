...
- Name: audit-becotoy.spec.ts >> Controle de acesso — Fotógrafo >> Fotógrafo NÃO acessa /dashboard/admin (redireciona)
- Location: tests\audit-becotoy.spec.ts:191:7
...
Expected pattern: /dashboard\/fotografo/
Received string:  "https://becotoy.com/dashboard/admin"
Timeout: 8000ms

Call log:
  - Expect "toHaveURL" with timeout 8000ms
    19 × unexpected value "https://becotoy.com/dashboard/admin"
