import { Search, Camera, Star, Award, Users, Zap, Shield, CreditCard, Smartphone, TrendingUp, Gift, Trophy, Dumbbell, Bike, Waves, GraduationCap, PartyPopper, Play, Target, Car, Wind, Mountain, ArrowRight } from 'lucide-react';
...
const categories = [
  ...
  { name: 'Crossfit', slug: 'crossfit', icon: Dumbbell },
  ...
  { name: 'Canoa Havaiana', slug: 'canoa-havanaina', icon: Waves },
  { name: 'Festas', slug: 'festas', icon: PartyPopper },
  { name: 'Automotiva', slug: 'automotiva', icon: Car },
  { name: 'Mountain Bike', slug: 'mountain-bike', icon: Mountain },
  { name: 'Treinos', slug: 'treinos', icon: Dumbbell },
  { name: 'Ginástica', slug: 'ginastica', icon: Dumbbell },
    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 px-4 bg-card">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { initials: 'MA', name: 'Maria Alves', city: 'São Paulo, SP', text: 'Encontrei minhas fotos da corrida em minutos! A qualidade é incrível e o preço é justo.' },
              { initials: 'JC', name: 'João Carlos', city: 'Rio de Janeiro, RJ', text: 'Como fotógrafo, a plataforma me ajudou a aumentar minhas vendas em 300%. Recomendo demais!' },
              { initials: 'PS', name: 'Paula Silva', city: 'Belo Horizonte, MG', text: 'A função de reconhecimento facial é incrível! Encontrei minha foto em questão de segundos.' },
            ].map((item) => (
              <div key={item.initials} className="bg-background p-6 rounded-2xl border border-white/10">
