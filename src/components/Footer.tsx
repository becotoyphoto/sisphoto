...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-[#DDE7F0] pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[#475366] text-sm max-w-md mb-6">
            ...
            <div className="space-y-2 text-sm text-[#475366]">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#475366]">
        ...
        {/* Company Info */}
        <div className="border-t border-[#DDE7F0] pt-8 mt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-[#475366]">
            <div>
              <h4 className="font-semibold text-[#282F3D] mb-1">BECOTOY LTDA.</h4>
              <p>CNPJ em atualização cadastral.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#282F3D] mb-1">Contato</h4>
            ...
            <div>
              <h4 className="font-semibold text-[#282F3D] mb-1">Redes Sociais</h4>
        ...
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t border-[#DDE7F0] text-center">
          <p className="text-[#798AA3] text-xs">
